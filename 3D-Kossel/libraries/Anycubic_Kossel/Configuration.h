...
// ----------------------->>> DAQ -- CUSTOM_MENDEL_NAME
// ----------------------->>> DAQ -- CUSTOM_MENDEL_NAME
// ----------------------->>> DAQ -- CUSTOM_MENDEL_NAME
#define CUSTOM_MENDEL_NAME "ANYCUBIC Q0.6"
...
// ----------------------->>> DAQ -- DELTA_SMOOTH_ROD_OFFSET
// ----------------------->>> DAQ -- DELTA_SMOOTH_ROD_OFFSET
// ----------------------->>> DAQ -- DELTA_SMOOTH_ROD_OFFSET
//#define DELTA_SMOOTH_ROD_OFFSET 151 // mm
//#define DELTA_SMOOTH_ROD_OFFSET 153.15 // mm
#define DELTA_SMOOTH_ROD_OFFSET 152.7 // mm
...
// ----------------------->>> DAQ --- MANUAL_Z_HOME_POS
// ----------------------->>> DAQ --- MANUAL_Z_HOME_POS
// ----------------------->>> DAQ --- MANUAL_Z_HOME_POS
//#define MANUAL_Z_HOME_POS 332.8  // 打印机归位时，喷嘴到平台的高度。For delta: Distance between nozzle and print surface after homing. 
#define MANUAL_Z_HOME_POS 300.75  // 打印机归位时，喷嘴到平台的高度。For delta: Distance between nozzle and print surface after homing. 
